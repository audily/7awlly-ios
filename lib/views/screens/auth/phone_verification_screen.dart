...
import '../../../controller/auth/phone_verification_otp_controller.dart';
...
class PhoneVerificationScreen extends StatelessWidget {
  ...
  final controller = Get.find<PhoneVerificationOtpController>();
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            PrimaryTextWidget(
              text: Get.find<SignUpController>().emailController.text.isEmpty
                  ? Get.find<SignInController>().emailOrUserNameController.text
    ...
    return Obx(() => Column(
          children: [
            ...
            controller.resendVisible.value
                ? TextButton(
                    onPressed: () {
                      controller.registerResendProcess();
                    },
