...
const String virtualCardKey = "virtualCardKey";
...
class LocalStorage {
  ...
  static Future<void> saveVirtualCard({required String virtualCard}) async {
    final box = GetStorage();

    await box.write(virtualCardKey, virtualCard);
  }

  static String? getVirtualCard() {
    var rtrn = GetStorage().read(virtualCardKey);
