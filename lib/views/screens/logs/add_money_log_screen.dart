...
class AddMoneyLogScreen extends StatelessWidget {
  AddMoneyLogScreen({Key? key}) : super(key: key);
  final _controller = Get.put(AddMoneyLogController());
                  ...
                  child: DelayedDisplay(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        !(data.status == 5 &&
                                data.gatewayCurrency
                                    .toString()
                                    .toLowerCase()
                                    .contains("tatum"))
                            ? SizedBox.shrink()
                            : Obx(() => _controller.isSubmitLoading
                                ? CustomLoadingAPI()
                                : Row(
                                    crossAxisAlignment: crossStart,
