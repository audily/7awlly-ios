...
import '../../../controller/logs/send_money_log_controller.dart';
...
class SendMoneyLogScreen extends StatelessWidget {
  SendMoneyLogScreen({Key? key}) : super(key: key);
  final _controller = Get.put(SendMoneyLogController());
                ...
                child: Visibility(
                  ...
                  child: DelayedDisplay(
                    ...
                    child: Column(
                      ...
                      children: [
                        // const Divider(),
                        /*      _rowWidget(Strings.receiver, data.receiverUsername),
                    const Divider(),*/
